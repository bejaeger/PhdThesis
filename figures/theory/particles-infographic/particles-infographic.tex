...
\newcommand\particle[8][white]{%
  \begin{tikzpicture}[x=1cm, y=1cm]
    ...
    \ifstrempty{#7}{}{\node at(0.8,-0.2) [rotate=-45,scale=0.21,color=white] {\textbf{#7}};}
    \ifstrempty{#8}{}{\node at(0.8,-0.2) [rotate=-45,scale=0.16,color=white] {\textbf{#8}};}
    \ifstrempty{#6}{}{\node at(0.9,-0.1)  [nosep,scale=0.2] {#6};}
