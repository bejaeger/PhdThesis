...
\definecolor{purple}{HTML}{9F8BC4}
...
\begin{tikzpicture}[x=1.2cm, y=1.2cm]
  ...
  \node at(4,-3)   {\particle[purple]
                   {$Z$}        {}                    {$91.2$ GeV}{1}{}{}};
  \node at(3.5,-2) {\particle[beige]
                   {$\gamma$}   {photon}                        {}{1}{}{}};
  \node at(3.5,-1) {\particle[lightred]
                   {$g$}        {gluons}                    {}{1}{}{color + anti-color}};
  ...
  \draw [brace] (4.5,.8)  -- (5.5,.8) node[toplabel]       {Electroweak\\symmetry breaking};
