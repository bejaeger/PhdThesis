...
\begin{tikzpicture}[
  ...
  \draw[pie style, fill={\colorset-3}]
    [shift=(\angleExplode:\radiusExplode)]
    (0,0) -- (\angle:\radiusInner)
    arc (\angle:\angle+\BRWW*3.6:\radiusInner) -- cycle;
  \node [yshift=-0.1 cm] at (\angle+0.5*\BRWW*3.6:0.45*\radius+\radiusExplode) {$W^+W^-$};
  \xdef\currentAngle{\angle}
  \pgfmathparse{\angle+\BRWW*3.6}
  \xdef\angle{\pgfmathresult}

  % outer slice around WW
  \outerSliceWLabel{\BRevmv*3.6}  {\angleExplode}{\radiusInner}{\radius}{\radiusExplode}{\colorset-3-1}{label_evmv}  {$e\nu\mu\nu$}
