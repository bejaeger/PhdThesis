...
\node[scale=1,anchor=west,rotate=0] at (1.5,-4) {ATLAS\_MET\_SoftTrk\_ResoPara};
\node[scale=1,anchor=west,rotate=0] at (1.5,-5) {theo\_ww\_QSF\_vbf};
\node[scale=1,anchor=west,rotate=0] at (1.5,-6) {theo\_ttbar\_fsr\_vbf};
\node[scale=1,anchor=west,rotate=0] at (1.5,-7) {theo\_ww\_CKKW\_vbf};
\node[scale=1,anchor=west,rotate=0] at (1.5,-8) {theo\_ggf\_shower};
\node[scale=1,anchor=west,rotate=0] at (1.5,-9) {ATLAS\_JES\_Flavor\_Comp};
\node[scale=1,anchor=west,rotate=0] at (1.5,-10) {theo\_ww\_scale\_vbf};
\node[scale=1,anchor=west,rotate=0] at (1.5,-11) {ATLAS\_LUMI};
\node[scale=1,anchor=west,rotate=0] at (1.5,-12) {theo\_ww\_CSSKIN\_vbf};
\node[scale=1,anchor=west,rotate=0] at (1.5,-13) {ATLAS\_MET\_SoftTrk\_ResoPerp};
\node[scale=1,anchor=west,rotate=0] at (1.5,-14) {theo\_ttbar\_shower\_vbf};
\node[scale=1,anchor=west,rotate=0] at (1.5,-15) {theo\_ewww\_ewcorr\_vbf};
\node[scale=1,anchor=west,rotate=0] at (1.5,-16) {theo\_ggf\_QCDscale\_ggH\_mig12};
\node[scale=1,anchor=west,rotate=0] at (1.5,-17) {ATLAS\_JES\_EtaInter\_Model};
\node[scale=1,anchor=west,rotate=0] at (1.5,-18) {ATLAS\_MET\_SoftTrk\_Scale};
\node[scale=1,anchor=west,rotate=0] at (1.5,-19) {ATLAS\_JER\_EffectiveNP\_1};
...
\begin{scope}[name=ranking,colEffectAxes,xscale=6.66667]
  ...
  \draw (-0.15,-0.2) -- (-0.15,0) node [axlbl,above=3pt]{-0.15};
  \draw (-0.15,0) -- (0.15,0);
  \node[axlbl,above left=5pt] at (-0.165,0) {$\Delta\mu$};
\end{scope}
...
\draw[colPullAxes] (0.75,-20.3) -- (0.75,-20.5) node [axlbl,below=3pt]{0.75};
\draw[colPullAxes] (1,-20.3) -- (1,-20.5) node [axlbl,below=3pt]{1};
\node[axlbl,colPullAxes,anchor=north east,xshift=-1em,yshift=-1em] at (-1,-20.5) {Pull};
