...
\node[scale=1,anchor=west,rotate=0] at (1.5,-3) {ttbar matching};
\node[scale=1,anchor=west,rotate=0] at (1.5,-4) {ggF shower};
\node[scale=1,anchor=west,rotate=0] at (1.5,-5) {ATLAS $E_{\rm T}^{\mathrm{miss}}$ soft term res., paralell};
\node[scale=1,anchor=west,rotate=0] at (1.5,-6) {ATLAS $E_{\rm T}^{\mathrm{miss}}$ soft term res., perpendicular};
\node[scale=1,anchor=west,rotate=0] at (1.5,-7) {$WW$ QSF};
\node[scale=1,anchor=west,rotate=0] at (1.5,-8) {$H \to WW$ branching fraction};
\node[scale=1,anchor=west,rotate=0] at (1.5,-9) {$WW$ CKKW};
\node[scale=1,anchor=west,rotate=0] at (1.5,-10) {$t\bar{t}$ FSR};
\node[scale=1,anchor=west,rotate=0] at (1.5,-11) {ATLAS luminosity};
\node[scale=1,anchor=west,rotate=0] at (1.5,-12) {$WW$ QCD scale};
\node[scale=1,anchor=west,rotate=0] at (1.5,-13) {$WW$ CSSKIN};
\node[scale=1,anchor=west,rotate=0] at (1.5,-14) {ATLAS JES flavor composition};
\node[scale=1,anchor=west,rotate=0] at (1.5,-15) {$t\bar{t}$ shower};
\node[scale=1,anchor=west,rotate=0] at (1.5,-16) {ATLAS JER effective NP1};
\node[scale=1,anchor=west,rotate=0] at (1.5,-17) {VBF PDF};
\node[scale=1,anchor=west,rotate=0] at (1.5,-18) {ATLAS $E_{\rm T}^{\mathrm{miss}}$ soft term energy scale};
\node[scale=1,anchor=west,rotate=0] at (1.5,-19) {ATLAS JES $\eta$ intercalibration};
...
\begin{scope}[name=ranking,colEffectAxes,xscale=6.66667]
  ...
  %\node[axlbl,above left=5pt,scale=1.1] at (-0.0830,0.5) {$\Delta\sigma_{\mathrm{VBF}} / \sigma_{\mathrm{VBF}}^{\mathrm{SM}}$};
    \node[axlbl,above left=5pt,scale=1.1] at (-0.0830,0.5) {$\Delta \mu_{\mathrm{VBF}}$};
