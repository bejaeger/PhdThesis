...
Specifically, the precise measurement of the Higgs boson's production and decay processes is crucial to constrain theories beyond the SM and may also reveal possible effects that new phenomena, which are not directly within experimental reach, have at the accessible energies, thereby indirectly paving the way to new discoveries. 
...
The second challenge is addressed in the analysis of the VBF signal, which is difficult to distinguish from non-VBF signal events. 
...
This contributes significantly to achieving more precise measurements of Higgs boson processes and thus to making progress in learning about the fundamental laws of nature.
