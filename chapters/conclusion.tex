...
In this thesis, contributions to this endeavor have been presented in different areas that build on each other. 
A measurement of the noise term of the jet energy resolution (JER) of particle flow jets was presented. This was crucial input to the calibration of the JER used in many physics analyses performed by the ATLAS collaboration. 
The calibration is also used in the measurement of the gluon fusion (ggF) and vector-boson fusion (VBF) production cross sections of the Higgs boson in its decays to a pair of $W$ bosons, which constitutes the main results of this work. 

The \HWW\ analysis was carried out using the full \RunTwo dataset of the LHC collected by the ATLAS experiment corresponding to 139\ifb\ proton-proton collisions at a center-of-mass energy of $\sqrt{s} = 13\,$TeV. 
...
Looking ahead, the data analysis of the full \RunTwo dataset has not yet been completed and consolidated results are expected in the coming years. For the \HWW analysis, for example, the author suggested alternative analysis strategies that could further improve the \HWW cross-section measurements. 
...
%at an ever more precise experimental map of all properties of the Higgs boson. 
...
The study of the Higgs boson and its unique properties will guide the physics community in this pursuit, striving to find hints of new phenomena through precision measurements. 
%in this pursuit. 
%The current situation in particle physics can also be framed differently, as 
%Most prominently, supersymmetry is not realized in nature in a way that has been predicted by several supersymmetric models. 
% \TDinote{}{Write that this is one of the most profound things that has happened, as it points toward the need to make a paradigm shift. Theories have to be put under scrutiny and the most fundamental principles may have to be revisited.}
...
If scientists continue to push beyond the boundaries of technology and collaborative practices, as has been so successfully demonstrated by the LHC program, there is little doubt that new insights will be made that will shed light on the open mysteries of the universe and bring humanity closer to having a complete description of the fundamental laws of nature. 
