...
This thesis presented measurements of the gluon fusion (ggF) and vector-boson fusion (VBF) production cross sections of the Higgs boson in its decays to a pair of $W$ bosons, using the full \RunTwo dataset of the LHC collected by the ATLAS experiment at $\sqrt{s} = 13\,$TeV and corresponding to 139\ifb. 
...
They will also continue to be the baseline for future analyses and reinterpretations such as in Effective Field Theories, which are expected to make a substantial impact to constraining theories beyond the SM or may open doors to new phenomena.
...
With more data, the properties of the Higgs boson can be studied at higher precision and new Higgs boson processes will become experimentally accessible. 
\TDinote{}{Mention coupling to second generation fermions}
This will allow rare Higgs boson processes to be studied, most notably the coupling of the Higgs boson to itself, which has never been measured before.
...
The Higgs program will continue to be of great importance and aims at an ever more precise experimental map of all properties of the Higgs boson. 
