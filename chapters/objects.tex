...
\Minote{}{Track reconstruction efficiency mentioned here!}
...
- some changes from previous publication \cite{PERF-2015-09} are described in \cite{JETM-2018-05}.
...
\Rinote{Maybe this can be mentioned in the electron and photon reconstruction}
