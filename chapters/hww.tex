...
This chapter presents cross-section measurements of \HWW decays, with the Higgs boson produced via the ggF and VBF production mode, using the 139\,\ifb $pp$ collision data at a center-of-mass energy $\sqrt{s} = 13\,$TeV collected by the ATLAS experiment during \RunTwo of the LHC. 
...
The analysis is published in \ccite{HWWPaper} and yields the most precise ggF and VBF Higgs cross-section measurements reported by the ATLAS collaboration to date.
...
It should be noted that the measurements presented supersede similar measurements performed with the same dataset but based on a previous version of the analysis published in \ccite{ATLAS-CONF-2021-014}.
...
This chapter begins with a brief overview of the analysis.
