...
This chapter presents cross-section measurements of \HWWdet decays, with the Higgs boson produced via the ggF and VBF production mode, using the $pp$ collision data at $\sqrt{s} = 13\,$TeV collected by the ATLAS experiment during \RunTwo of the LHC corresponding to 139\,\ifb. 
...
An analysis targeting similar signal processes and based on the full \RunTwo dataset was published by the CMS collaboration in \ccite{Sirunyan_2021}. 
