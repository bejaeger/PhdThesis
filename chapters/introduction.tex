...
\Cref{chap:comb} summarizes the latest combined measurements of Higgs boson interactions performed by the ATLAS collaboration.
    ...
    \item Contributions to the \HWW analysis (\cref{chap:hww})
          \begin{itemize}
            ...
            %   \item Construction and optimization of DNN discriminant in the statistical analysis for all VBF cross-section measurements (\cref{sec:dnn}).
              ...
              \item Study of different analysis strategies to improve the background estimation and reduce systematic uncertainties, in particular for the VBF and VBF STXS measurement (\cref{sec:bkg-estimation}).
