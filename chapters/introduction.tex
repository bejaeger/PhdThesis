...
% (i) the ability to find regions of phase space that exhibit a large signal-to-background ratio, where signal is the process under investigation and background everything else.
% (ii) the ability to precisely estimate the background contribution. 

% (ii) is handled by the noise term measurement
% (i) is handled by the DNN
...
\subsection*{Outline of the thesis and contributions by the author}
...
\Cref{chap:higgs} summarizes the phenomenology and recent measurements of Higgs boson processes to place the research presented in this thesis in a broader context. 
...
\Cref{chap:hww} is the main part of this thesis and presents the measurement of VBF and ggF Higgs boson production in the \HWW\ decay channel that is published in \cref{CouplingsPaper}. The author contributed significantly to many aspects of the analysis, focusing on the measurement of the VBF production mode. 
