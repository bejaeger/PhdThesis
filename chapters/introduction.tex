...
\noindent This thesis is structured as follows. \Cref{chap:theory} summarizes the theoretical framework of the Standard Model and introduces the concepts required to describe and measure $pp$ collision events.
...
\Cref{chap:higgs} provides additional motivation for performing Higgs boson measurements and summarizes the phenomenology and recent measurements of Higgs boson processes. This allows placing the research presented in this thesis in a broader context.
...
\Cref{chap:hww} is the main part of this thesis and presents the measurement of VBF and ggF Higgs boson production cross sections in the \HWW\ decay channel. The results presented are published in \ccite{HWWPaper}. 
...
\begin{itemize}
    ...
    \item General contributions to ATLAS analysis groups, mostly related to software
          ...
          \end{itemize}
\end{itemize}
Besides these main contributions, the author frequently contributed to review meetings, performed several smaller optimization and validation studies, is co-author of the internal supporting documentation, and provided final results for the analysis published in \ccite{HWWPaper} as well as the jet energy resolution measurement published in \ccite{JETM-2018-05}.
