...
\input{chapters/intro-v3}

\quad \newline

This thesis is structured as follows. \Cref{chap:theory} summarizes the theoretical framework of the Standard Model and introduces the concepts required to describe and measure $pp$ collision events.
...
\Cref{chap:ml} introduces the machine learning techniques used to develop a deep neural network that distinguishes VBF, \HWW signal events from other events.
\Cref{chap:hww} is the main part of this thesis and presents the measurement of VBF and ggF Higgs boson production cross sections in the \HWW\ decay channel. The analysis presented is published in \ccite{HWWPaper}. 
...
\begin{itemize}
    \item All aspects of the noise term measurement of the jet energy resolution (\cref{chap:calibration})
          \begin{itemize}
              \item Developed new strategies to perform noise term measurement for particle flow jets
          ...
          \end{itemize}
    \item Contributions to analysis of VBF, \HWW decays (\cref{chap:hww})
          \begin{itemize}
              \item Trained and validated the deep neural network (DNN) used in the VBF, \HWW analysis (\cref{sec:dnn,app:chap:DNN})
              \item Deployed DNN output as discriminant in statistical analysis for all VBF cross-section measurements (\cref{sec:dnn})
          ...
          \end{itemize}
    \item General contributions to ATLAS analysis groups, mostly related to \HWW analysis
          \begin{itemize}
              \item Co-developed analysis framework and statistical framework and contributed to software tutorials
          ...
          \end{itemize}
\end{itemize}
Besides these main contributions, the author frequently contributed to review meetings, performed several smaller optimization and validation studies, is co-author of the internal supporting documentation, and provided final results for the analysis published in \ccite{HWWPaper} and the calibration measurement published in \ccite{JETM-2018-05}.
