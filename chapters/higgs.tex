...
This section provides an overview of the phenomenology of Higgs boson physics. \Cref{subsec:higgschannels} summarizes the different production and decay modes of the Higgs boson at the LHC, and \cref{subsec:exp-accessibility} discusses their experimental accessibility. \Cref{subsec:xsec-measurements} outlines the different types of Higgs production cross-section measurements, before \cref{subsec:higgs-exp-status} concludes with a brief overview of the experimental status of Higgs physics at the time of writing.
...
The Higgs production cross sections depend, among other things, on the center-of-mass energy of the collider.
...
The production in association with a top-quark pair ($ttH$) is characterized by two top quarks in the final state. 
...
The Higgs boson production in association with a $b\bar{b}$ pair ($pp\rightarrow bbH$) or a single-top quark ($pp \rightarrow tH$) have small contributions at the LHC, but are still relevant for combined measurements.
...
\section{Experimental sensitivity of Higgs boson decays at the LHC}
...
The couplings of the Higgs boson to individual particles can be measured by parametrizing the cross sections and branching fractions for the individual Higgs processes in terms of coupling-strength modifiers, $\kappa$, following the $\kappa$-framework \cite{LHCHandbookV3}. 
