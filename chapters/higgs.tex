...
The latest Higgs boson measurements performed by the ATLAS collaboration are summarized in \ccite{NaturePaper} and briefly discussed here.\footnote{Similar measurements by the CMS collaboration are published in \ccite{CMSNaturePaper}.}
