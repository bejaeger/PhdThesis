...
In the work presented in this thesis, piece-wise linear interpolation is used for this purpose. 
\TDinote{}{Add sentence about shape uncertainties varying yields in bins so that shape of distribution is altered, and normalization uncertainties, having the same relative effect in the bins in each bin?}
