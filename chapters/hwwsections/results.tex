...
\end{align*}$}
\end{gather}
where $11.3\pm 0.5$~pb is expected from the SM predictions.
...
\Cref{fig:STXS-correlation} shows the correlations between the measured cross sections. 
...
\begin{figure}[!h]
  ...
  \caption[Post-fit DNN output distributions in the VBF STXS signal regions.]{
    ...
    Figure taken and caption adapted from \ccite{HWWPaper}. 
