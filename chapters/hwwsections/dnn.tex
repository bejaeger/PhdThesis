...
\todo{MAYBE explain bin-by-bin significance and binning optimization?}
...
% It would therefore be natural to directly optimize the discovery significance when training the neural network. 
...
%     \item Information about systematic uncertainties is included in the discovery significance to perform the final optimization and choose the neural network. 
% \end{itemize}
...
% The loss function must be fully differentiable with respect to the parameters of the model in order to perform gradient descent optimization.
% This requires the definition of a metric that can be optimized to achieve exactly this. 
