...
\begin{table}[h]
  ...
  \caption{
    ...
    Alternative event generators or quantities varied to estimate systematic uncertainties are shown in parentheses. Table and caption taken from \cref{HWWPaper}.}
    \label{tab:mcsamples}
    \resizebox{\textwidth}{!}{
      \input{tables/hww/samples}
