...
Since the simulation infrastructure is described in great detail in the original publication \cite{HWWPaper}, the remainder of this section is quoted directly.
\FloatBarrier
\begin{table}[t]
  \centering
  \caption{
    ...
    Alternative event generators or quantities varied to estimate systematic uncertainties are shown in parentheses. The table and caption is published in \cite{HWWPaper}.}
  \label{tab:mcsamples}
  \resizebox{\textwidth}{!}{
