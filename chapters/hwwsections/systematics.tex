...
The uncertainty on the luminosity is 1.7\%, obtained using the LUCID-2 detector~\cite{ATLAS-CONF-2019-021}, and only applied to processes estimated using MC simulation. 
...
The parton shower uncertainty is the leading uncertainty in the VBF measurement because of sizeable differences in the prediction of potential jets in addition to the two leading jets between the nominal sample (\POWHEG+\PythiaEight) and the sample with an alternative shower model (\POWHEG+\HERWIG[7]).
