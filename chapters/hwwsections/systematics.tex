...
\begin{table}[ht]
    ...
    \end{center}
    \caption{Summary of experimental uncertainties considered in the \HWW analysis, including their total number of nuisance parameters (NPs) and a specification whether they represent scale-factor (SF) uncertainties or four-vector (P4) uncertainties.
    }
...
The uncertainty due to the choice of parton shower model is covered by two separate comparisons based on generator-level samples, that are discussed in \cref{subsec:data-mc-samples}. 
