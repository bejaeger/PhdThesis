...
\TDinote{}{I might wanna add background composition plots! And maybe a cutflow?}
...
\begin{table}[ht]
    \caption{
      ...
      The selections starts from the nominal CR selections summarized in \cref{tab:CRsSelection}.
