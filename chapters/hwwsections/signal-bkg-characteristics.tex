...
The analysis presented is therefore sensitive only to the ggF and VBF production modes of the \HWWdet\ decay. \TDinote{Contributions from above-mentioned other Higgs channels are treated like backgrounds and normalized to their corresponding SM predictions.}{Probably mention only later!}
