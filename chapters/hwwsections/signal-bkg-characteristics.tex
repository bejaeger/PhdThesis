...
\begin{figure}[ht]
    \subfloat[\ttbar] {
        \newImageResizeCustom{0.3}{figures/hww/feynman/ttbar.pdf}
        \label{fig:hww:feyn-bkgs-ttbar}
    } \hspace{5em}
    \subfloat[$Wt$] {
        \newImageResizeCustom{0.3}{figures/hww/feynman/Wt.pdf}
        \label{fig:hww:feyn-bkgs-wt}
    } \\
    \subfloat[quark-induced $WW$] {
        \newImageResizeCustom{0.3}{figures/hww/feynman/WW.pdf}
        \label{fig:hww:feyn-bkgs-qqWW}
    } \hspace{5em}
    \subfloat[EW~$WW$] {
        \newImageResizeCustom{0.3}{figures/hww/feynman/EWWW.pdf}
        \label{fig:hww:feyn-bkgs-EWWW}
    } \\
    \subfloat[\Ztt] {
        \newImageResizeCustom{0.3}{figures/hww/feynman/Ztt.pdf}
        \label{fig:hww:feyn-bkgs-Ztautau}
    } \hspace{5em}
    \subfloat[$W$+jets] {
        \newImageResizeCustom{0.3}{figures/hww/feynman/Wjetslvlv.pdf}
