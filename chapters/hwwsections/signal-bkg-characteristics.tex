...
$W\gamma$ and $Z\gamma$ processes can mimic the signature of the signal processes, if the photon is misidentified as an electron. This can occur, if the photon converts to an electron-positron pair and therefore is reconstructed as one isolated lepton. 
