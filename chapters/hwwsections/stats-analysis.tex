...
\TDinote{}{Maybe this could be put into the results section. I think that would make sense.}
% From Paper
...
\TDinote{}{Maybe mention that fit to observed is performed and pulls are looked at BEFORE results}
...
The NPs are ordered in terms of their contribution to the total uncertainty (\emph{breakdown}) on the signal strength $\mu_{\mathrm{VBF}}$. 
