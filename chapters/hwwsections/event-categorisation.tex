...
A common event preselection is applied before the events are divided into separate analysis regions targeting different signal categories.
...
\begin{figure}
    ...
    \caption{Jet multiplicity distribution for jets with \ptGT{30}\,GeV and \absetaST{4.5}, after applying the preselection criteria including pre-fit normalisation. The various background components are discussed in more detail in the text. Previously published in \ccite{ATLAS-CONF-2021-014}.}
    \label{fig:njet-dist}
\end{figure}
...
\todo{ALL 1to1 COPIED FROM PAPER FOR NOW}
