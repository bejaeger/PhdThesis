...
\end{equation}
where \fEM is the fraction of the jet that interacts electromagnetically. This fraction increases as the energy of the jet increases, because the number of possibilities to produce neutral pions increases. The calorimeter response is therefore \emph{nonlinear} with increasing jet energy.
...
\begin{figure}
    \newImageResizeCustom{0.55}{figures/calibration/jes-calibration-jet-response.pdf}
    \caption[The average jet energy response.]{The average energy response as a function of (a) \etadet and (b) \Ereco of the reconstructed jet. Each value is obtained from the corresponding parameterized function derived with the Pythia8 MC sample and only jets satisfying $\pT > 20\,GeV$ are shown. Taken from \ccite{JETM-2018-05}.}
...
\begin{figure}[t]
    ...
    \caption[Relative Balance JER as a function of \pT.]{Relative Balance JER as a function of \pT for PFlow+JES jets in the central region of the detector, measured in dijet events and MC simulation using Pythia8. Previously published in \ccite{JETM-2018-05}.}
...
\begin{figure}[t]
    ...
    \caption[The relative JER for fully calibrated jets.]{The relative jet energy resolution for fully calibrated PFlow+JES jets (blue curve) and EM+JES jets (green curve) (a) as a function of \pTjet and (b) as a function of $\eta$. Figure and caption taken from \ccite{JETM-2018-05}.}
