...
The final-state partons then undergo a process called \emph{hadronization} (also called \emph{fragmentation}), due to the confining nature of QCD. They end up forming a spray of color-neutral hadrons, which are known as particle \emph{jets}.
