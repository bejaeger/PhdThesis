...
\Cref{subsec:pp-collision-overview} provides a brief overview of the anatomy of a $pp$ collision event and introduces key terminology. \Cref{subsec:collision-rates} outlines basic observables and \cref{subsec:factorisation} discusses the concepts necessary to compute theoretical particle interaction cross sections.
...
The final-state partons then undergo a process called \emph{hadronisation} (also \emph{fragmentation}), due to the confining nature of QCD. They end up forming a spray of color-neutral hadrons, which are known as particle \emph{jets}.
