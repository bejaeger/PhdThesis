...
The detector geometry and the response to different particles is simulated using the {\verb GEANT4 } toolkit \cite{Agostinelli:2002hh}. 
This involves the consideration of all detector inefficiencies. 
