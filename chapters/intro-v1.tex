...
Elementary particle physics took on the challenge to learn the fundamental laws of nature by describing the behavior of the  elementary building blocks of matter, the \emph{elementary particles}. 
...
The collision events are measured by large detector machines built around the interaction point. The ATLAS experiment is one such example, built as a multi-purpose detector for a variety of physics application. It is also excellent in measuring the type of detector signals that events with Higgs bosons give rise to. 
