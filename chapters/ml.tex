...
While in the past, many HEP applications were based on \emph{boosted decision trees} (BDTs), the most widely adopted models today are based on (deep) neural networks, which are powerful discriminators because of their ability to approximate any nonlinear function~\cite{HORNIK1989359}.
