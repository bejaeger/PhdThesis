...
The \HWW analysis contributes the most to the measurement of the $qq\to Hqq$ (or EW~$qqH$) and $gg \to H$ signals defined as discussed in \cref{subsec:STXS-categorization}.\footnote{The signal definition for the other three classes ($t\bar{t}H$, $tH$, $pp\to VH$) is detailed in \ccite{NaturePaper}.}
...
\begin{figure}
    \newImageResizeCustom{0.75}{figures/higgs-combination/comb-inclusive-xsecs.pdf}
...
\begin{figure}
    \newImageResizeCustom{0.75}{figures/higgs-combination/comb-stxs-xsecs.pdf}
    \caption{
