...
\begin{figure}[t]
    ...
    \caption[Fraction of the expected background events in the highest DNN output bin.]{Fraction of the expected background events in the highest DNN output bin based on the validation set of a 5-fold cross-validation procedure for (a) default training fractions and (b) optimized EW~$WW$ training fraction.}
